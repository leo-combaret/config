...
sudo 
'/Library/Application Support/org.pqrs/Karabiner-Elements/uninstall.sh'
```
...
1. Log files Delete the following directories: /var/log/karabiner ~/.local/share/karabiner
2. Temporary directories Delete the following directories: /Library/Application Support/org.pqrs/tmp
3. Setting files Delete the following directories: ~/.config/karabiner