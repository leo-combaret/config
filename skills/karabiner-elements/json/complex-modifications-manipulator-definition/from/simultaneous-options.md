...
"Pressing the tab,q keys simultaneously launches Mission Control (key_down_order)"
,
...
"Pressing the tab,q keys simultaneously launches Mission Control (key_up_order)"
,
...
Example:
- Mouse Keys Mode v4 json json generator Import