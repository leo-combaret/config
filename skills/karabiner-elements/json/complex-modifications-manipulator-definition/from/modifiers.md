...
"Change escape to tab (without from.modifiers)"
,
...
This json defines manipulator which changes escape to tab . ( left_shift and left_control can be pressed.)
```
{
...
"Change escape to tab (from.modifiers.optional)"
,
...
This json defines manipulator which changes control + h to delete_or_backspace .
```
{
...
"Change control+h to delete_or_backspace (from.modifiers.mandatory)"
,
...
"Change control+h to delete_or_backspace (mandatory and optional)"
,
...
"Change caps_lock+m to mission_control"
,
