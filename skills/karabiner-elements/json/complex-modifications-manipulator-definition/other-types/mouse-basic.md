...
| conditions | Optional | Same as basic.conditions |
When using discard, make sure to explicitly specify the device using conditions. Otherwise, there’s a risk that the mouse cursor may become completely unmovable.
## Example
