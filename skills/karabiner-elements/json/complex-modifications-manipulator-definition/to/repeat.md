...
- If to.repeat is true : key_up event is sent when you release the key.
- If to.repeat is false : key_down and key_up events are sent when you press the key.
## Example
