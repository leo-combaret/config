...
- TypeScript (built-in)
> If your language isn't listed, you can contribute by adding a debug adapter for it. Check out our
> debugger extensions
...
## Troubleshooting
If you're running into problems with the debugger, please open a GitHub issue , providing as much context as possible. There are also some features you can use to gather more information about the problem:
