...
Your selected icon theme is stored in your settings file. You can open your settings file from the command palette with zed: open settings file (bound to cmd-alt-,|ctrl-alt-, ).
