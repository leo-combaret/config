...
- For pull requests that are reverts: If the item being reverted has already been shipped , include a Release Notes line explaining why we reverted, as this is a breaking change.
