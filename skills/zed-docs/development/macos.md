...
- Ensure that the Xcode command line tools are using your newly installed copy of Xcode: sudo xcode-select --switch /Applications/Xcode.app/Contents/Developer sudo xcodebuild -license accept
- Install cmake (required by a dependency ) brew install cmake
...
```
> Note:
> In the future, baselines may be stored externally. For now, they
