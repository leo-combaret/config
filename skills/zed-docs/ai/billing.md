# Billing
This page covers billing for Zed's subscription plans . For details on what's included in each plan and how token usage works, see Plans and Usage .
We use Stripe as our payments provider, and Orb for invoicing and metering. All Pro plans require payment via credit card or other supported payment method. For invoice-based billing, a Business plan is required. Contact sales@zed.dev for more information.
## Billing Information
Access billing information and settings at dashboard.zed.dev/account . This page embeds data from Orb, our invoicing and metering partner.
## Billing Cycles
...
## Payment Failures
If payment of an invoice fails, Zed will block usage of our hosted models until the payment is complete. Email billing-support@zed.dev for assistance.
## Invoice History
You can access your invoice history by navigating to dashboard.zed.dev/account and clicking Invoice history within the embedded Orb portal.
If you require historical Stripe invoices, email billing-support@zed.dev
## Updating Billing Information
Email billing-support@zed.dev for help updating payment methods, names, addresses, and tax information.
...
Please note that changes to VAT/GST IDs and address will only affect future invoices — we cannot modify historical invoices . Questions or issues can be directed to billing-support@zed.dev .