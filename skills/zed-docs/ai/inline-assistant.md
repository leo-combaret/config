# Inline Assistant
## Usage Overview
Use ctrl-enter|ctrl-enter to open the Inline Assistant in editors, the rules library, channel notes, and the terminal panel.
...
> Unlike the Agent Panel, though, the only exception at the moment is
> external agents
> .
