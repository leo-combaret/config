...
3. The invitee receives an email with instructions to join. After accepting, they authenticate via GitHub.
### Changing a Member's Role
1. On the Members page, find the member. You can filter by role or search by name.
