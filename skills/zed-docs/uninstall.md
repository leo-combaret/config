...
3. Delete the following directories if they exist: ~/Library/Application Support/Zed ~/Library/Saved Application State/dev.zed.Zed.savedState ~/Library/Logs/Zed ~/Library/Caches/dev.zed.Zed ~/Library/Caches/Zed ~/.config/zed ~/.local/state/Zed
## Linux
### Standard Uninstall
