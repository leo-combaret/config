...
> This is
> only
> the case for development builds. For all non-development
...
1. Enable measurements: export ZED_MEASUREMENTS=1
2. Test the first version: Checkout the commit you want to measure Run Zed in release mode and use it for 5-10 seconds: cargo run --release &> version-a
3. Test the second version: Checkout another commit you want to compare Run Zed in release mode and use it for 5-10 seconds: cargo run --release &> version-b
4. Generate comparison: script/histogram version-a version-b
