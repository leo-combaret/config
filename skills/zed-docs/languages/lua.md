...
```
1. Add "hint.enable": true to your .luarc.json .
## Formatting
### LuaLS Formatting
...
1. Install StyLua : brew install stylua or cargo install stylua --features lua52,lua53,lua54,luau,luajit (feel free to remove any Lua versions you don't need).
