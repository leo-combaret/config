...
```
See gopls code lenses documentation for more information.
## Debugging
...
- Delve configuration documentation
### Debug Go Packages
...
If you need to build your application with a specific command, you can use the "exec" mode of Delve. In this case "program" should point to an executable, and the "build" command should build that.
```
[
  {
