...
- Language Server: open-policy-agent/regal
## Installation
The extension is largely based on the Regal language server which should be installed to make use of the extension. Read the getting started instructions for more information.
## Configuration
