...
> Note:
> You cannot delete the branch you currently have checked out. Switch to a different branch first.
## Merge Conflicts
...
> Tip:
> For complex conflicts that need manual editing, you can edit the file directly. Remove the conflict markers (
> <<<<<<<
> ,
> =======
> ,
> >>>>>>>
> ) and keep the content you want.
## Stashing
...
| Action | Keybinding |
| --- | --- |
| Apply stash | ctrl-space|ctrl-space |
| Pop stash (apply and remove) | ctrl-shift-space|ctrl-shift-space |
| Drop stash (remove without applying) | ctrl-shift-backspace|ctrl-shift-backspace |
## AI Support in Git
...
```
To customize the format of generated commit messages, run agent: open rules library and select the "Commit message" rule on the left side. From there, you can modify the prompt to match your desired format.
...
> The
> Escape
> key is the quickest way to collapse all expanded diff hunks and return to an overview of your changes.
## Action Reference
| Action | Keybinding |
| --- | --- |
| git: add | No default binding |
| git: stage all | cmd-ctrl-y|ctrl-space |
| git: unstage all | cmd-ctrl-shift-y|ctrl-shift-space |
| git: toggle staged | space|space |
| git: stage and next | cmd-y|alt-y |
| git: unstage and next | cmd-shift-y|alt-shift-y |
| git: commit | cmd-enter|ctrl-enter |
| git: expand commit editor | shift-escape| |
| git: push | ctrl-g up|ctrl-g up |
| git: force push | ctrl-g shift-up|ctrl-g shift-up |
| git: pull | ctrl-g down|ctrl-g down |
| git: pull rebase | ctrl-g shift-down|ctrl-g shift-down |
| git: fetch | ctrl-g ctrl-g|ctrl-g ctrl-g |
| git: diff | ctrl-g d|ctrl-g d |
| git: restore | cmd-alt-z|ctrl-k ctrl-r |
| git: restore file | cmd-delete|ctrl-delete |
...
| editor: expand all diff hunks | cmd-"|ctrl-" |
| editor: toggle selected diff hunks | cmd-'|ctrl-' |
