...
See All Settings for additional information and other non-visual settings.
## Themes
You can install many themes and icon themes in form of extensions by running zed: extensions from the command palette.
